...
class DRLlibv2:
    ...
    def train_tune_model(self):
        ...
        # if self.search_alg is not None: self.search_alg.save_to_dir(self.storage_path)
        # ray.shutdown()
        return self.results
    ...
    def restore_agent(
        ...
        """
        # if restore_search:
        # self.search_alg = self.search_alg.restore_from_dir(self.storage_path)
        if checkpoint_path == "":
        ...
        # self.search_alg.save_to_dir(self.storage_path)
        return self.results

    def get_test_agent(self, checkpoint=None):
        """
        Get test agent
        """
